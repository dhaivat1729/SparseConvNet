...
class Model(nn.Module):
    def __init__(self):
        ...
        self.linear = nn.Linear(sum(nPlanes), 2)
    def forward(self,x):
...
class train_road_segmentation():
    ...
    def train_model(self):
        ...
        for epoch in range(self.p['n_epochs']):
            ...
            ## Test the model being trained at every few iterations
            if (epoch+1)%2 == 0:
                self.test_model()
...
torch.save(trainobj.model, '/home/dhai1729/road_segmentation_fully_connected.model')    
